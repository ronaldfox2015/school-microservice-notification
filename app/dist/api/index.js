...
const config_service_1 = require("../src/context/common/domain/helper/config.service");
const http_exception_filter_1 = require("../src/context/common/domain/helper/http-exception.filter");
const logger_interceptor_1 = require("../src/app/interceptor/logger.interceptor");
const logger_service_1 = require("../src/context/common/application/service/logger.service");
let cachedApp;
