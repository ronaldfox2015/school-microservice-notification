...
import { type BaseExceptionResponse } from '@common/application/exception/base.exception'
...
export class HttpExceptionFilter implements ExceptionFilter {
  ...
  public catch (exception: any, host: ArgumentsHost): void {
    ...
    const baseInputException = exception.response as BaseExceptionResponse<any>
